...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand " href=index.html>Mehmet Salih Tüysüz</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href=index.html>Anasayfa/Hakkımda</a>
                </li>
                <li class="nav-item">
...
<!--Menu kismi-->
    ...
    <section class="p-5 text-center">
        <div class="container">
            <br><br>
            <h2 class="mb-3 font-weight-bold" id="basliklar">İLETİSİM BİLGİLER</h2><i  ></i>
            <hr class="cizgi">
        </div>
    </section>
    <br><br>
